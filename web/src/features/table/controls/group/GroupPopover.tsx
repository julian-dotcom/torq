  ...
  return (
    <Popover button={popOverButton}>
      <div className={styles.groupRowWrapper}>
        <button
          className={classNames(styles.groupRow, {[styles.groupRowSelected]: (groupedBy == 'channels')})}
          onClick={() =>{
        ...
        <button
          className={classNames(styles.groupRow, {[styles.groupRowSelected]: (groupedBy == 'peers')})}
          onClick={() =>{
