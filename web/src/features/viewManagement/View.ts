...
//     console.log(this.view.columns.length);
//     const view = produce(this.view, (draft) => {
//       draft.columns.push(createDraft(column));
//       console.log(draft.columns.length);
//       return draft;
//       // return { ...draft, columns: [...draft.columns, column] };
//     });
//     this.view = view;
//     // this.render();
//   };
