...
const data = [
  { date: new Date(2022, 1, 1), revenue: 231.0, capacity: 9303000 },
  { date: new Date(2022, 1, 2), revenue: 231.0, capacity: 9303000 },
  { date: new Date(2022, 1, 3), revenue: 231.0, capacity: 9303000 },
  { date: new Date(2022, 1, 4), revenue: 280.4, capacity: 8185000 },
  { date: new Date(2022, 1, 5), revenue: 270.9, capacity: 8213000 },
  { date: new Date(2022, 1, 6), revenue: 280.4, capacity: 8518000 },
  { date: new Date(2022, 1, 7), revenue: 250.3, capacity: 8991000 },
  { date: new Date(2022, 1, 8), revenue: 280.6, capacity: 8620000 },
  { date: new Date(2022, 1, 9), revenue: 210.5, capacity: 8479000 },
  { date: new Date(2022, 1, 10), revenue: 280.5, capacity: 8479000 },
  { date: new Date(2022, 1, 11), revenue: 210.7, capacity: 8217000 },
  { date: new Date(2022, 1, 12), revenue: 280.8, capacity: 8085000 },
  { date: new Date(2022, 1, 13), revenue: 220.3, capacity: 8638000 },
  { date: new Date(2022, 1, 14), revenue: 280.5, capacity: 8778000 },
  { date: new Date(2022, 1, 15), revenue: 280.8, capacity: 8352000 },
  { date: new Date(2022, 1, 16), revenue: 280.8, capacity: 8352000 },
  { date: new Date(2022, 1, 17), revenue: 280.8, capacity: 8352000 },
  { date: new Date(2022, 1, 18), revenue: 280.8, capacity: 8352000 },
  { date: new Date(2022, 1, 19), revenue: 280.8, capacity: 8352000 },
];
