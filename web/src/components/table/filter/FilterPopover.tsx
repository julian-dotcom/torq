...
import TorqInput from "../../inputs/TorqInput";
    ...
    <div className={classNames("filter-row", {first: props.first})}>
      ...
      {(!props.first && (
          <div className="combiner-container">
            <TorqSelect options={combinerOptions} defaultValue={combinerOptions[0]}/>
          </div>)
      )}
      ...
      <div className="filter-function-container">
        <TorqSelect options={functionOptions} defaultValue={functionOptions[0]} />
      </div>
