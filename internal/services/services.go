...
type CommonService struct {
	ServiceType       services_core.ServiceType   `json:"type"`
	ServiceTypeString string                      `json:"typeString"`
	Status            services_core.ServiceStatus `json:"status"`
...
type ServiceMismatch struct {
	...
	Status              services_core.ServiceStatus `json:"status"`
	StatusString        string                      `json:"statusString"`
	DesiredStatus       services_core.ServiceStatus `json:"desiredStatus"`
