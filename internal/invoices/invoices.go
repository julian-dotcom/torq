...
type Invoice struct {
	...
	AmountPaid        *float64   `json:"amountPaid" db:"amt_paid"`
	...
	PaymentAddr       *string    `json:"paymentAddress" db:"payment_addr"`
	FallbackAddr      *string    `json:"fallbackAddress" db:"fallback_addr"`
	...
	Private           *bool      `json:"isPrivate" db:"private"`
}
